...
public interface ParticipantDao {
    ...
    List<? extends Participant> getParticipantListByGroupWithRelativeObjects(Class<? extends Participant> cls, int groupId) throws FailedOperationException, ObjectNotFoundException;
